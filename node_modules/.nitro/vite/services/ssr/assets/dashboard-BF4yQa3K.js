...
import { t as requireSupabaseAuth } from "./auth-middleware-Dv7rYwEy.js";
import { t as supabase } from "./client-BZaQbCef.js";
import { n as useAuth } from "./auth-context-J0MGvtDS.js";
import { a as formatCurrency } from "./format-CUlL4Oov.js";
...
import { t as createSsrRpc } from "./createSsrRpc-CWb7Nc4C.js";
import { n as useCurrency } from "./currency-sync-MWB7XA2f.js";
...
import { Bell, CheckCircle2, Flame, PiggyBank, RefreshCw, Repeat, Sparkles, Target, TrendingDown, TrendingUp, Wallet } from "lucide-react";
...
//#endregion
//#region src/lib/insights.functions.ts
...
//#endregion
//#region src/components/ai-insights.tsx
function AIInsights() {
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsxs(CardHeader, {
			...
			children: [/* @__PURE__ */ jsxs(CardTitle, {
				...
				children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4 text-primary" }), " AI Financial Insights"]
			}), /* @__PURE__ */ jsxs(Button, {
				size: "sm",
				variant: "outline",
				onClick: () => m.mutate(),
				disabled: m.isPending,
				children: [/* @__PURE__ */ jsx(RefreshCw, { className: `mr-1.5 h-3.5 w-3.5 ${m.isPending ? "animate-spin" : ""}` }), m.data ? "Refresh" : "Generate"]
			})]
		}), /* @__PURE__ */ jsxs(CardContent, { children: [
			!m.data && !m.isPending && /* @__PURE__ */ jsx("p", {
				className: "text-sm text-muted-foreground",
				children: "Get personalized, AI-powered advice on your spending, savings and habits."
			}),
			m.isPending && /* @__PURE__ */ jsxs("div", {
				className: "space-y-2",
				children: [
					/* @__PURE__ */ jsx("div", { className: "h-3 w-3/4 animate-pulse rounded bg-muted" }),
					/* @__PURE__ */ jsx("div", { className: "h-3 w-full animate-pulse rounded bg-muted" }),
					/* @__PURE__ */ jsx("div", { className: "h-3 w-5/6 animate-pulse rounded bg-muted" })
				]
			}),
			m.data && /* @__PURE__ */ jsx("div", {
...
function renderMarkdown(text) {
	return /* @__PURE__ */ jsx("ul", {
		className: "space-y-2",
		children: text.split("\n").filter((l) => l.trim()).map((line, i) => /* @__PURE__ */ jsxs("li", {
			className: "flex gap-2 text-sm leading-relaxed",
			children: [/* @__PURE__ */ jsx("span", { className: "mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" }), /* @__PURE__ */ jsx("span", { children: line.replace(/^[-*•]\s*/, "").replace(/\*\*/g, "") })]
		}, i))
	});
}
//#endregion
//#region src/components/reminders.tsx
function Reminders() {
	const { user } = useAuth();
	const uid = user?.id;
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, {
			...
			children: [
				...
				" Reminders",
				items.length > 0 && /* @__PURE__ */ jsx("span", {
					className: "ml-auto rounded-full bg-primary/10 px-2 py-0.5 text-xs font-medium text-primary",
					children: items.length
				})
			]
		}) }), /* @__PURE__ */ jsx(CardContent, { children: items.length === 0 ? /* @__PURE__ */ jsx("p", {
			className: "text-sm text-muted-foreground",
...
function Dashboard() {
	...
	if (loading || !uid || !data) return /* @__PURE__ */ jsx(LoadingBlock, {});
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx(StatCard, {
						icon: /* @__PURE__ */ jsx(PiggyBank, { className: "h-5 w-5" }),
						label: "Net savings",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(AIInsights, {})
				}), /* @__PURE__ */ jsx(Reminders, {})]
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "grid gap-6 lg:grid-cols-3",
				children: [/* @__PURE__ */ jsxs(Card, {
					className: "lg:col-span-2 shadow-soft",
					children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Income vs Expenses (6 months)" }) }), /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", {
					...
					className: "shadow-soft",
					children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Spending by category" }) }), /* @__PURE__ */ jsx(CardContent, { children: catData.length === 0 ? /* @__PURE__ */ jsx(EmptyBlock, { children: "No expenses yet." }) : /* @__PURE__ */ jsx("div", {
						className: "h-56 sm:h-72 w-full",
						children: /* @__PURE__ */ jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxs(PieChart, { children: [/* @__PURE__ */ jsx(Pie, {
							...
							outerRadius: 90,
							paddingAngle: 2,
							children: catData.map((_, i) => /* @__PURE__ */ jsx(Cell, { fill: COLORS[i % COLORS.length] }, i))
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Card, {
					...
					children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ jsx(Flame, { className: "h-4 w-4 text-primary" }), " Best habit streak"]
					}) }), /* @__PURE__ */ jsxs(CardContent, { children: [
						/* @__PURE__ */ jsx("div", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [habitStats.slice(0, 4).map((h) => /* @__PURE__ */ jsxs("div", {
							...
							}, h.name)), habitStats.length === 0 && /* @__PURE__ */ jsx(EmptyBlock, { children: "No habits yet." })]
						})
					] })]
				}), /* @__PURE__ */ jsxs(Card, {
					className: "lg:col-span-2 shadow-soft",
					children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, {
						className: "flex items-center gap-2",
						children: [/* @__PURE__ */ jsx(Target, { className: "h-4 w-4 text-primary" }), " Savings goals progress"]
					}) }), /* @__PURE__ */ jsxs(CardContent, {
						className: "space-y-4",
						children: [data.goals.length === 0 && /* @__PURE__ */ jsx(EmptyBlock, { children: "Set your first savings goal." }), data.goals.slice(0, 4).map((g) => {
							...
							return /* @__PURE__ */ jsxs("div", { children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("span", { children: [pct.toFixed(0), "% complete"] }), daysLeft !== null && /* @__PURE__ */ jsx("span", { children: daysLeft > 0 ? `${daysLeft} days left` : "Due" })]
								})
							] }, g.id);
						})]
					})]
			...
			data.investments.length > 0 && /* @__PURE__ */ jsxs(Card, {
				className: "shadow-soft",
				children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Investment portfolio" }) }), /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx("div", {

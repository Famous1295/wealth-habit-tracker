...
import { a as formatCurrency, o as formatDate } from "./format-CUlL4Oov.js";
import { i as CardTitle, n as CardContent, r as CardHeader, t as Card } from "./card-BXjpJ96D.js";
import { n as Input, t as Label } from "./label-N2deYTEC.js";
...
//#region src/routes/_authenticated/goals.tsx?tsr-split=component
function GoalsPage() {
	const { user } = useAuth();
	const uid = user.id;
		...
		children: [
			...
			/* @__PURE__ */ jsxs(Card, {
				...
				children: [/* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsxs(CardTitle, {
					...
					children: [/* @__PURE__ */ jsx(Target, { className: "h-4 w-4 text-primary" }), " New goal"]
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "Target amount" }), /* @__PURE__ */ jsx(Input, {
							type: "number",
							min: "0.01",
							step: "0.01",
							value: target,
						...
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "Starting saved" }), /* @__PURE__ */ jsx(Input, {
							type: "number",
							min: "0",
							step: "0.01",
							value: saved,
						...
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "Target date" }), /* @__PURE__ */ jsx(Input, {
							type: "date",
							value: targetDate,
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs(Button, {
								...
								children: [/* @__PURE__ */ jsx(Plus, { className: "mr-1 h-4 w-4" }), " Create goal"]
							})
						})
					]
				}) })]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [goals.length === 0 && /* @__PURE__ */ jsx(Card, {
						...
						children: /* @__PURE__ */ jsxs(CardContent, {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("span", { children: [pct.toFixed(1), "%"] }), g.target_date && /* @__PURE__ */ jsx("span", { children: daysLeft && daysLeft > 0 ? `${daysLeft} days left · ${formatDate(g.target_date)}` : "Due" })]
								}),
								/* @__PURE__ */ jsxs("div", {
								...
								/* @__PURE__ */ jsx(ManualContribution, {
									goalId: g.id,
									current: s,
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: /* @__PURE__ */ jsxs("span", {
										...
										children: [/* @__PURE__ */ jsx(TrendingUp, { className: "h-3 w-3 text-primary" }), " keep contributing"]
									})
								})
							]
						})

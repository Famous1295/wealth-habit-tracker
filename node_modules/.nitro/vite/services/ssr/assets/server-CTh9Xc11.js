...
import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-DUi6CTCH.js";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-22QKHsgV.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-SR8T-W4S.js"),
		import("./start-CuYMAt6x.js"),

...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DUi6CTCH.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-22QKHsgV.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-SR8T-W4S.mjs"),
		import("./start-CuYMAt6x.mjs"),
